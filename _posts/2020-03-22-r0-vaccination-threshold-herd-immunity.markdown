...
In the movie Contagion (2011), Dr. Erin Mears (played by Kate Winslet), an [Epidemic Intelligence Service (EIS)][eis] officer with the CDC, explains to a meeting room the concept of $$R_0$$ using less than 2 minutes, and a whiteboard. This post is a deeper dive into this number and related concepts, given its resurgence in the light of COVID-19. 
